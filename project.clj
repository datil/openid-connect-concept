(defproject openid-connect-concept "0.1.0"
  :description "An OpenID Connect concepto implementation"
  :url "http://github.com/datil/openid-connect-concept"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "openid-connect-concept.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.0"]]}
             :uberjar {:aot [openid-connect-concept.server]}}
  :main ^{:skip-aot true} openid-connect-concept.server)
